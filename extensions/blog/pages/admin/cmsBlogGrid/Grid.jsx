...
export default function CMSPageGrid({
  blogPages: { items: pages, total, currentFilters = [] },
}) {
  console.log(pages)
                ...
                coreComponents={[
                  {
                    component: {
                      default: () => (
                        <PageName url={`${p.editUrl}?blog=1`} name={p.name} />
                      ),
                    },
                    sortOrder: 10,
                  },
                  {
                    component: {
                      default: () => (
                        <PageName
                          url={`/admin/blog?limit=20&blog=1&category%5Bvalue%5D=${p.category}&category%5Boperation%5D=eq`}
                          name={p.category}
                        />
                      ),
                    },
