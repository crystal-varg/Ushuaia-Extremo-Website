  ...
  return (
    <div id="shopping-cart-items">
      <table className=" listing">
        <thead className="monumental text-base font-bold">
          <tr>
            <td>
              <span>{_("Product")}</span>
            </td>
            ...
            <tr key={item.cartItemId}>
                ...
                <div className="flex justify-start space-x-4 product-info">
                  ...
                  <div className="cart-tem-info">
                    <a
                      ...
                      className="name font-bold hover:underline monumental text-base line-clamp-2"
                    >
                      {item.productName}
                    </a>
                    {item.errors.map((e, i) => (
              ...
              <td>
                {item.finalPrice.value < item.productPrice.value && (
                  <div>
                    <span className="regular-price monumental text-base">
                      {priceIncludingTax
                        ? item.productPriceInclTax.text
                        : item.productPrice.text}
                    </span>{" "}
                    <span className="sale-price monumental text-base">
                      {priceIncludingTax
              ...
              <td className="hidden md:table-cell monumental text-base">
                <span>
                  {priceIncludingTax
