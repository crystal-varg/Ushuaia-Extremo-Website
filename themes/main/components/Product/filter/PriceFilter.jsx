...
export function PriceFilter({
  ...
  return (
    <div className="price-filter">
      <div className="filter-item-title font-extrabold monumental text-lg text-[#3A3A3A]">
        {_("Price")}
      </div>
      <div className="rangeslider">
        ...
        <div className="tooltip min">
          <div className="push" />
          <output className="text-xs monumental">${from}</output>
        </div>
        <input
          className="max"
          type="range"
        ...
        />
        <div className="tooltip max justify-end">
          <div className="push" />
          <output className="text-xs monumental">${to}</output>
        </div>
      </div>
    </div>
  );
