  ...
  return (
    <div className="category-filter mt-8">
      <div className="filter-item-title">
        <span className="monumental font-extrabold text-lg text-[#3A3A3A]">
          {_("Category")}
        </span>
      </div>
          ...
          return (
            <li key={c.uuid} className="mt-2 mr-2">
              ...
              >
                ...
                <span className="filter-option text-[#3A3A3A] font-normal monumental text-[12px] min-w-[120px] text-ellipsis overflow-hidden whitespace-nowrap">
                  {c.name}
                </span>
              </a>
            </li>
