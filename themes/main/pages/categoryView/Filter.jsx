...
import { useAppDispatch } from "@evershop/evershop/src/components/common/context/app";
import "./Filter.scss";
import { PriceFilter } from "../../components/Product/filter/PriceFilter";
import { AttributeFilter } from "../../components/Product/filter/AttributeFilter";
    ...
    <FilterDispatch.Provider value={contextValue}>
      ...
      >
        <div className="filter-heading">
          <span className="font-bold monumental text-base">{_("SHOP BY")}</span>
        </div>
        <Area
          id="productFilter"
          noOuter
          ...
          coreComponents={[
            ...
            },
            {
              ...
              props: {
                ...
                updateFilter,
                setting,
                categories: getAllCategories(children),
              },
              sortOrder: 15,
            },
            {
