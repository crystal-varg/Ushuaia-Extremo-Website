...
export default function FeaturedExcursions({ myFeaturedProducts }) {
  ...
  return (
    <div
      className="-mt-32 w-full max-lg:h-fit max-lg:!bg-none max-lg:-mt-28"
      style={{
        backgroundImage:
          "linear-gradient(to top,rgba(255, 255, 255, 1) 0%, rgba(255, 255, 255, 0) 50%), url('/images/IceBackground.png')",
